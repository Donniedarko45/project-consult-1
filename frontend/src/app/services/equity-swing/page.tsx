...
export default function EquitySwingPage() {
  return (
    <main className="min-h-screen bg-[#1F1209] text-orange-50 relative overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="text-center mb-20 max-w-4xl mx-auto">
          <FadeIn>
            ...
            <p className="text-xl md:text-2xl text-orange-200/70 font-light leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-6xl mx-auto">
           <FadeIn direction="right" className="bg-orange-950/30 border border-orange-900/50 p-10 rounded-[40px] flex flex-col justify-center">
              <BarChart className="w-12 h-12 text-orange-500 mb-8" />
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex gap-4 items-center">
                     ...
                     <span className="text-lg text-orange-100/80">{text}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-12">
                <Link 
                  href="/signup" 
                  className="inline-block bg-orange-600 hover:bg-orange-500 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg"
                >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            ...
            <FadeIn delay={0.2} className="p-8 rounded-3xl bg-[#2a170d] border border-orange-900/30">
              <RefreshCcw className="w-8 h-8 text-blue-500 mb-6" />
