...
export default function MarketDirectionPage() {
  return (
    <main className="min-h-screen bg-[#020617] text-slate-300 relative overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <FadeIn direction="up">
          <div className="grid md:grid-cols-2 gap-12 bg-slate-900/50 backdrop-blur-3xl border border-slate-800 rounded-[40px] p-8 md:p-16 shadow-2xl mb-24">
            <div className="flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-950/50 border border-blue-800/50 text-blue-400 mb-8 font-bold tracking-widest text-xs uppercase w-max">
                <Compass className="w-4 h-4" /> Market Context
              </div>
              <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight text-white">
                Never trade against the <span className="text-blue-500">Macro Trend.</span>
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 mt-4">Clarity comes from looking at the bigger picture.</p>
          </div>
