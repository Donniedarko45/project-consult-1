...
export default function CashIntradayPage() {
  return (
    <>
    <main id="main-content" className="min-h-screen bg-[#1c1917] text-stone-300 relative overflow-hidden font-sans">
      ...
      <section className="container mx-auto px-4 py-24 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center border-b border-stone-800 pb-20 mb-20">
           <FadeIn direction="right" className="lg:w-1/2">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-rose-950 border border-rose-900/50 text-rose-400 mb-8 font-bold tracking-widest text-xs uppercase w-max">
              <Shield className="w-4 h-4" aria-hidden="true" /> Strictly Non-Leveraged
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <FadeIn delay={0.1} className="bg-stone-900 p-8 rounded-3xl border border-stone-800">
              <AlertOctagon className="w-10 h-10 text-rose-500 mb-6" aria-hidden="true" />
            ...
            <FadeIn delay={0.2} className="bg-stone-900 p-8 rounded-3xl border border-stone-800">
              <LineChart className="w-10 h-10 text-rose-500 mb-6" aria-hidden="true" />
            ...
            <FadeIn delay={0.3} className="bg-stone-900 p-8 rounded-3xl border border-stone-800">
              <Target className="w-10 h-10 text-rose-500 mb-6" aria-hidden="true" />
            ...
            <FadeIn delay={0.4} className="bg-stone-900 p-8 rounded-3xl border border-rose-900/50 bg-rose-950/10">
              <Shield className="w-10 h-10 text-rose-500 mb-6" aria-hidden="true" />
