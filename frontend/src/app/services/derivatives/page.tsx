...
export default function DerivativesPage() {
  return (
    <main className="min-h-screen bg-[#070512] text-gray-200 relative overflow-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 px-4 text-center z-10 border-b border-fuchsia-900/20">
        <FadeIn>
          <div className="mx-auto w-24 h-24 bg-fuchsia-900/30 rounded-3xl rotate-12 flex items-center justify-center text-fuchsia-400 mb-8 border border-fuchsia-500/30 shadow-[0_0_50px_rgba(217,70,239,0.2)]">
            <Activity className="w-12 h-12 -rotate-12" />
          </div>
          ...
          <p className="text-xl md:text-2xl text-purple-200/60 font-light max-w-3xl mx-auto leading-relaxed mb-12">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <FadeIn direction="left" className="space-y-8">
            <h2 className="text-4xl font-black text-white">Why Trade F&O With Us?</h2>
