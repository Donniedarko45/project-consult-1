...
export default function HighConvictionPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-300 relative overflow-hidden font-sans pb-20">
      {/* Luxury Gold Accents */}
      ...
      <div className="container mx-auto px-4 py-20 relative z-10 max-w-7xl">
              ...
              {[
                ...
                <div key={i} className="flex gap-6 items-start group">
                  <div className="w-14 h-14 rounded-full bg-[#111] border border-yellow-900/30 flex items-center justify-center shrink-0 group-hover:border-yellow-500/50 transition-colors">
                    <item.icon className="w-6 h-6 text-yellow-600 group-hover:text-yellow-400 transition-colors" />
                  </div>
                  <div>
        ...
        <div className="text-center bg-[#111] border border-yellow-900/30 rounded-3xl p-12 max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <h3 className="text-3xl font-black text-white mb-6 relative z-10">Ready to Upgrade Your Precision?</h3>
          ...
          <Link 
            href="/signup" 
            className="relative z-10 inline-flex items-center gap-3 bg-gradient-to-r from-yellow-600 to-amber-700 hover:from-yellow-500 hover:to-amber-600 text-white px-12 py-5 rounded-full font-black text-xl transition-all shadow-[0_0_40px_rgba(217,119,6,0.3)] hover:scale-105"
          >
