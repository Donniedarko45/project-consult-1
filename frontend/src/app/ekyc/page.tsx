          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 overflow-hidden">
            ...
            {step === "kyc" && (
              <>
                ...
                <form className="p-6 space-y-5" onSubmit={handlePanSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all font-mono tracking-widest uppercase"
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <><ShieldCheck className="w-5 h-5" /> Verify PAN</>
                    )}
                  </button>
...
function StepDot({
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <span className={`text-[10px] font-semibold uppercase tracking-wide ${active ? "text-primary" : "text-slate-400"}`}>
        {label}
      </span>
    </div>
  );
...
function ErrorBox({ message }: { message: string }) {
  return (
    <div className="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/50 text-red-600 dark:text-red-400 text-sm flex items-start gap-3">
