      ...
      <div className="p-8 lg:p-10 flex flex-col h-full relative z-10">
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="text-right">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-[10px] font-black uppercase tracking-widest">Premium Service</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-sm font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest leading-relaxed">
        ...
        <div className="grow space-y-6 text-sm text-gray-600 dark:text-gray-300">
          <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-white/5 group-hover:border-primary/20 transition-colors">
            <span className="text-gray-600 dark:text-gray-400 font-bold uppercase tracking-widest text-[10px]">Trading Style</span>
            <span className="font-black text-foreground">{tradingStyle}</span>
          </div>
          <div className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-white/5 group-hover:border-primary/20 transition-colors">
            <span className="text-gray-600 dark:text-gray-400 font-bold uppercase tracking-widest text-[10px]">Alert Mode</span>
        ...
        <div className="pt-10 mt-8 border-t border-gray-100 dark:border-white/5">
          <div className="flex items-center justify-between mb-8">
            <div className="space-y-0.5">
              <p className="text-[10px] font-black uppercase tracking-widest text-gray-600 dark:text-gray-400">Monthly Plan</p>
              <p className="text-3xl font-black text-foreground tracking-tighter">
                <span className="text-sm font-bold text-gray-600 dark:text-gray-400 mr-1 uppercase">from</span>
                {price}
              </p>
            </div>
          </div>
          ...
          <Link
            href="/plans"
            aria-label={`Subscribe now to ${instrument}`}
          ...
          >
            Subscribe Now{" "}
            <ArrowRight aria-hidden="true" className="w-5 h-5 ml-3 transform group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
      </div>
    </div>
